...
// Tipado opcional de la organización
// import type { IOrganizacion } from '@/types/IOrganizacion'

interface Props {
	// user: Partial<IOrganizacion> | any
	user: any
	isEditing: boolean
...
// Configuración de campos del formulario para Organización
// Mostramos solo: nombre, tipo, direccion, email
const fields = computed(() => [
	{
		key: 'nombre',
		label: t.value.orgName,
		type: 'text',
		placeholder: t.value.orgNamePlaceholder,
	},
	{
		key: 'tipo',
		label: t.value.orgType,
		type: 'text',
		placeholder: t.value.orgTypePlaceholder,
	},
	{
		key: 'direccion',
		label: t.value.address,
		type: 'text',
		placeholder: t.value.addressPlaceholder,
	},
	{
		key: 'email',
