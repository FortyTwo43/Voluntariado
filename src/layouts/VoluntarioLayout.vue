    ...
    <div class="layout-container">
      ...
      <aside class="sidebar" :class="{ 'sidebar-open': sidebarOpen }">
        ...
        <nav class="sidebar-nav">
          <router-link to="/explorar-proyectos" class="sidebar-link" @click="onNavClick">
            <svg class="sidebar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <circle cx="11" cy="11" r="8"/>
              <path d="m21 21-4.35-4.35"/>
            </svg>
            <span class="sidebar-text">Explorar Proyectos</span>
          </router-link>

          <router-link to="/mis-proyectos" class="sidebar-link" @click="onNavClick">
            <svg class="sidebar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <router-link to="/calendario" class="sidebar-link" @click="onNavClick">
            <svg class="sidebar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <router-link to="/mis-asistencias" class="sidebar-link" @click="onNavClick">
            <svg class="sidebar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M9 11l3 3L22 4"/>
              <path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/>
            </svg>
            <span class="sidebar-text">Ver Asistencias</span>
          </router-link>

          <router-link to="/mis-inscripciones" class="sidebar-link" @click="onNavClick">
            <svg class="sidebar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <span class="sidebar-text">Mis Inscripciones</span>
          </router-link>
        </nav>
      </aside>
